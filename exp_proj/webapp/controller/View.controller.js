...
function (Controller,Fragment,Filter,FilterOperator,SearchField,MessageToast, ValueHelpDialog,JSONModel) {
    "use strict";

    return Controller.extend("exprpt.expproj.controller.View", {
        onInit: function () {
