		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#exprptexpproj-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"exprptexpproj-display": {
								"semanticObject": "exprptexpproj",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=exprpt.expproj",
									"url": sap.ui.require.toUrl("exprpt/expproj")
								}
							}
						}
					}
