		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "GL Cost Wise Report",
									"targetURL": "#glcostreptglcostreport-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"glcostreptglcostreport-display": {
								"semanticObject": "glcostreptglcostreport",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=glcostrept.glcostreport",
									"url": sap.ui.require.toUrl("glcostrept/glcostreport")
								}
							}
						}
					}
