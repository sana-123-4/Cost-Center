		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#costcenterrptproject2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"costcenterrptproject2-display": {
								"semanticObject": "costcenterrptproject2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=costcenterrpt.project2",
									"url": sap.ui.require.toUrl("costcenterrpt/project2")
								}
							}
						}
					}
