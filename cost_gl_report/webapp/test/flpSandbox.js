		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Cost GL Report",
									"targetURL": "#costglrptcostglreport-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"costglrptcostglreport-display": {
								"semanticObject": "costglrptcostglreport",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=costglrpt.costglreport",
									"url": sap.ui.require.toUrl("costglrpt/costglreport")
								}
							}
						}
					}
