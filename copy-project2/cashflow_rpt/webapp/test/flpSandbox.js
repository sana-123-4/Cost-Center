		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#cashflowcashflowrpt-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cashflowcashflowrpt-display": {
								"semanticObject": "cashflowcashflowrpt",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cashflow.cashflowrpt",
									"url": sap.ui.require.toUrl("cashflow/cashflowrpt")
								}
							}
						}
					}
