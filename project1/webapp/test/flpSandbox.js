		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Expense Wise Cost Center Report",
									"targetURL": "#expcostcenterproject1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"expcostcenterproject1-display": {
								"semanticObject": "expcostcenterproject1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=expcostcenter.project1",
									"url": sap.ui.require.toUrl("expcostcenter/project1")
								}
							}
						}
					}
